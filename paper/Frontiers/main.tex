...
We constructed a \denovo transcriptome using long-read data, and successfully assigned 19794 transcript isoforms in total, including clinically-relevant, but yet uncharacterized modes of transcription, such as intron retention or antisense overlapping transcription.
